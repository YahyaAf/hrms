                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" step="0.01" id="solde_recuperation" name="solde_recuperation" class="pl-10 w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-200" placeholder="X jours">
                                        </div>
                                    </div>
