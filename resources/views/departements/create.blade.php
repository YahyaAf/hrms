            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-lg">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-indigo-600 p-6 text-white">
                    <div class="flex justify-between items-center">
                        <h1 class="text-2xl font-bold">Créer un Département</h1>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-50 rounded-lg p-6 shadow-inner">
                        <form action="{{ route('departements.store') }}" method="POST">
                            ...
                            <div class="flex items-center justify-end">
                                <button type="button" onclick="window.location='{{ route('departements.index') }}'" class="mr-4 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200">
                                    Annuler
                                </button>
